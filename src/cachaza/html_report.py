...
<details class="section" open id="key-findings-section"><summary>Key findings</summary><div class="section-body"><p class="section-note">Concise, deduplicated highlights. Subdomains are capped at 13 here; complete values remain in the evidence explorer and JSON/CSV reports.</p>__ZONE_WARNING____KEY_FINDINGS__</div></details>
