...
class WebAdapterTests(unittest.TestCase):
    ...
    def test_katana_and_cariddi_keep_url_scope(self) -> None:
        katana_row = {"request": {"endpoint": "https://api.example.com/app.js"}}
        ...
        self.assertTrue(cariddi_findings[0].metadata["secret_candidate"])
    ...
    def test_jsmap_policy_and_favicon_are_normalized(self) -> None:
        ...
        self.assertTrue(js_findings[0].metadata["secret_candidate"])
