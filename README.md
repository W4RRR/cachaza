...
Once v1.0.5 has been merged into `main` and the `v1.0.5` Release has been published from that same commit, the normal upgrade is:
...
The second command must print `cachaza 1.0.5`.
...
git tag -a v1.0.5 -m "Cachaza v1.0.5"
